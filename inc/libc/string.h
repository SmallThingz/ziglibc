...
void *memcpy(void *__zrestrict s1, const void *__zrestrict s2, size_t n);
void *memmove(void *s1, const void *s2, size_t n);
char *strcpy(char *__zrestrict s1, const char *__zrestrict s2);
char *strncpy(char *__zrestrict s1, const char *__zrestrict s2, size_t n);
char *strcat(char *__zrestrict s1, const char *__zrestrict s2);
char *strncat(char *__zrestrict s1, const char *__zrestrict s2, size_t n);
int memcmp(const void *s1, const void *s2, size_t n);
int strcmp(const char *s1, const char *s2);
int strcoll(const char *s1, const char *s2);
int strncmp(const char *s1, const char *s2, size_t n);
size_t strxfrm(char *__zrestrict s1, const char *__zrestrict s2, size_t n);
...
char *strtok(char *__zrestrict s1, const char *__zrestrict s2);
